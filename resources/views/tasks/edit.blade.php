          ...
          <div class="panel-body">
            ...
            <form action="{{ route('tasks.edit',['folder'=>$task->folder_id, 'task'=>$task->id]) }}" method="post">
              ...
              <div class="form-group">
                ...
                <input class="form-control" id="title" type="text" name="title" value="{{ old('title', $task->title) }}">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control" id="due_date" type="text" name="due_date" value="{{ old('due_date') ?? $task->formatted_due_date }}">
              </div>
